...
public class Student {
	...
	// kor, eng, math의 총합을 return하는 메서드 생성.
	public int allPlus() {
		return this.kor + this.eng + this.math;
	}
	
	// kor, eng, math의 평균값을 return하는 메서드를 생성
	public int average() {
		return (this.kor + this.eng + this.math)/3;	// allPlus()/3; -> 위에 메서드를 활용하기
	}

	// name, ban, no, kor, eng, math 를 출력하는 메서드 생성
	public void say() {
		System.out.println( "Student [name=" + name + ", ban=" + ban + ", no=" + no + ", kor=" + kor + ", eng=" + eng + ", math="
				+ math + "]" );
	}
